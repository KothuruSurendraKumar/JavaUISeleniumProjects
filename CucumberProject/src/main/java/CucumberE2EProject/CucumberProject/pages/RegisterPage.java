...
public class RegisterPage {
	...
	public AccountSuccesPage clickOnContinoue() {
	...
	public void enterFirstName(String firstNameText) {
		...
		elementUtils.typeTestInField(firstNameField, firstNameText,CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
		
	}
	
	public void enterLastName(String lastNameText) {
		
		elementUtils.typeTestInField(lastNameField, lastNameText,CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
		
	}
	
	public void enterEmailAddress(String emailText) {
		
		elementUtils.typeTestInField(emailField, emailText,CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
		
	}
	
	public void enterTelephoneNumber(String telephoneText) {
		
		elementUtils.typeTestInField(telephoneField, telephoneText,CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
		
	}
	
	public void enterPassword(String passwordText) {
		
		elementUtils.typeTestInField(passwordField, passwordText,CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
		
	}
	
	public void enterConfirmPassword(String passwordText) {
		
		elementUtils.typeTestInField(passwordConfirmField, passwordText,CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
